...
<html>
  ...
  <body>
    ...
    <div class="content">
      <div class="cards">
        ...
        <div class="card">
          ...
          <h4 class="humidityColor"><i class="fas fa-tint"></i> Water Height</h4>
          <p class="humidityColor"><span class="reading"><span id="sensor_Slave_1"></span> cm</span></p>
          <br>
          <h4 class="temperatureColor"><i class="fas fa-signal"></i> RSSI</h4>
          <p class="temperatureColor"><span class="reading"><span id="RSSI_Slave_1"></span> dBm</span></p>
          <!-- *********************************************************************** -->
          ...
          <p class="statusreadColor"><span>Status Read Sensor Water Height : </span><span id="status_read_sensor_Slave_1"></span></p>
          <!-- *********************************************************************** -->
        </div>
        <!-- ======================================================================================================= -->
        ...
        <div class="card">
          ...
          <h4 class="humidityColor"><i class="fas fa-tint"></i> Water Height</h4>
          <p class="humidityColor"><span class="reading"><span id="sensor_Slave_2"></span> cm</span></p>
          <br>
          <h4 class="temperatureColor"><i class="fas fa-signal"></i> RSSI</h4>
          <p class="temperatureColor"><span class="reading"><span id="RSSI_Slave_2"></span> dBm</span></p>
          <!-- *********************************************************************** -->
          ...
          <p class="statusreadColor"><span>Status Read Sensor Water Height : </span><span id="status_read_sensor_Slave_2"></span></p>
          <!-- *********************************************************************** -->
        </div>  
        <!-- ======================================================================================================= -->
    ...
    <script>
      ...
      //------------------------------------------------------------
      document.getElementById("sensor_Slave_1").innerHTML = "NN";
      document.getElementById("RSSI_Slave_1").innerHTML = "NN";
      document.getElementById("status_read_sensor_Slave_1").innerHTML = "NN";
      document.getElementById("LTRD_Slave_1").innerHTML = "NN";
      
      
      document.getElementById("sensor_Slave_2").innerHTML = "NN";
      document.getElementById("RSSI_Slave_2").innerHTML = "NN";
      document.getElementById("status_read_sensor_Slave_2").innerHTML = "NN";
      ...
      if (!!window.EventSource) {
        ...
        source.addEventListener('allDataJSON', function(e) {
          ...
          if (obj.ID_Slave == "S1") {
            document.getElementById("status_read_sensor_Slave_1").innerHTML = obj.StatusReadSensor;
            if (obj.StatusReadSensor == "FAILED") {
              document.getElementById("status_read_sensor_Slave_1").style.color = "red";
            } else {
              document.getElementById("status_read_sensor_Slave_1").style.color = "#702963";
            }
            
            document.getElementById("sensor_Slave_1").innerHTML = obj.Sensor;
          ...
          if (obj.ID_Slave == "S2") {
            document.getElementById("status_read_sensor_Slave_2").innerHTML = obj.StatusReadSensor;
            
            if (obj.StatusReadSensor == "FAILED") {
              document.getElementById("status_read_sensor_Slave_2").style.color = "red";
            } else {
              document.getElementById("status_read_sensor_Slave_2").style.color = "#702963";
            }
            
            document.getElementById("sensor_Slave_2").innerHTML = obj.Sensor;
